...
func NewGameSolution(blocks []*block.Block, shapeIndex []int, shifts []vector.V) *GameSolution {
	sol := GameSolution{}

	sol.Blocks = make([]*block.Block, len(blocks))
...
func (gs *GameSolution) GetCenterOfGravity() vectorf.V {
	c := vectorf.V{}
...
func (gs *GameSolution) GetBoundingBox() vector.V {
	bb := vector.V{}
